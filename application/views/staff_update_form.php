                                ...
                                <form method="post" enctype="multipart/form-data" action="<?php echo site_url(); ?>/staff/update/<?php echo $staff_records[0]->id; ?>">
                                   ...
                                   <div class="clearfix"></div>
                                    ...
                                    <div class="form-group col-md-8 col-lg-4">
                                        ...
                                        <input type="number" name="mobile_no" value="<?php echo $staff_records[0]->cell_number; ?>" class="form-control" placeholder="Cell No">
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group col-md-8 col-lg-4">
                                    ...
                                    <div class="form-group col-md-8 col-lg-4">
                                        ...
                                        <textarea name="address" class="form-control" id="" cols="30" rows="7"><?php echo $staff_records[0]->address; ?></textarea>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group col-md-8 col-lg-4">
