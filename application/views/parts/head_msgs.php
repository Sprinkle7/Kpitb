    <body class="page-header-fixed">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s1">
            ...
            <div class="slimscroll">
               ...
               <?php if($this->session->userdata('FirstName')==$res->fIrst_name) { ?>
                      <?php } else { ?>  
                      <a onClick="javascript:chatWith('<?php echo $res->fIrst_name; ?>');" >
                      <div class="msg-img">
                          <img src="<?php echo base_url();?>assets/VisualData/img.jpg" alt="">
                          <p class="msg-name">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2">
            <h3><span class="pull-left"><?php echo $this->session->userdata('FirstName').' '.$this->session->userdata('LastName');?></span> <a href="javascript:void(0);" class="pull-right" id="closeRight2"><i class="fa fa-angle-right"></i></a></h3>
		</nav>
        <!-- ENDS HERE -->
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        ...
                                        <img class="img-circle avatar" src="<?php echo base_url();?>assets/VisualData/img.jpg" width="40" height="40" alt="">
                                    </a>
