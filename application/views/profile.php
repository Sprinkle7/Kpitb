                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="panel info-box panel-white">
                            ...
                            <div class="profile-image-container contain">
                                <img src="<?php echo base_url();?>assets/VisualData/<?php echo $info->picture;?>" alt="">
                            ...
                            <ul class="list-unstyled text-center">
                                <li><p><i class="fa fa-map-marker m-r-xs textCap"></i><?php echo $info->address;?></p></li>
                            ...
                            <hr>
                                ...
                                <table class="table table-striped MarginTop">
                                    ...
                                    <tr>
                                        <th>Contact #</th>
                                        <td><?php echo $info->cell_number;?></td>
                                    </tr>
                                    <tr>
                                        <th>Signature</th>
